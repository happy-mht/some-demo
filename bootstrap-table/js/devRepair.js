...
function operateFormatter(value, row, index) {
	return [
		...
		'<button type="button" class="RoleOfB btn-default bt-select oper">报修</button>',
	].join('');
}
$(document).ready(function() {
	...
	var repairmodal = new Modal({
		...
		buttons: [{
			...
			html: '<button type="button" class="btn btn-sm btn-ok">取消</button>',
			selector: '.btn-cancel',
			callback: function() {
				//点击确定按钮的回调
			}
	...
	$table.bootstrapTable({
		//url: 'http://192.168.1.224:8080/itsmain/webapi/device/signalmachine/',
		data: data,
	...
	$('#btn_search').click(function() {
		...
		//		$.ajax({
		//			type: 'GET',
		//			url: "http://192.168.1.251:8080/itsmain/webapi/device/signalmachine",
		...
		//			dataType: 'json',
		//		});
		//var data1=$.ajax({url:"http://192.168.1.224:8080/itsmain/webapi/device/signalmachine/",async:false});		
	});
})